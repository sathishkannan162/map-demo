...
const allCoords = Object.keys(buildingMapObject).map((key) => key.split(",").map(Number))
...
export function MapComponent() {
  ...
  const [targetPos, setTargetPos] = useState<[number, number]>([maxX - 1, maxY - 1])
  ...
  return (
    <>
      ...
      <div className="w-full h-screen">
        <MapContainer center={pixelToLatLng(2, 2)} zoom={20} style={{ height: "100%", width: "100%" }} crs={L.CRS.Simple}>
